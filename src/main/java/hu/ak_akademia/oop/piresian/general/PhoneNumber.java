...
import hu.ak_akademia.oop.piresian.Main;
...
//
    ...
    public void makePosteriorCheck(Operator operator) throws InvalidInput {
...
//
    ...
    private void checkLocalLength(Operator operator) throws InvalidLengthOfLocalComponent {
